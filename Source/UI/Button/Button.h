...
{    
    ...
    const float BUTTON_SELECTED_SCALE = 1.25f;
    ...
    protected:
        ...
        ButtonState HandleTouchInput(TouchEvent* touchEvent);
        ButtonState HandleMouseClickInput(MouseClickEvent* mouseMovementEvent);
