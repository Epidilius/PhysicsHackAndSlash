...
//General Settings
#define ROOT_SCENE Game

//iOS Simulation
#define SIMULATE_TOUCH_EVENTS_WITH_MOUSE 1
#define SIMULATE_IOS_DEVICE_SCALE 1


//iOS Platform Settings
#define IOS_TARGET_FPS 30
